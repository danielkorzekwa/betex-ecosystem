...
set MARKETDATACOLLECTOR_OPTIONS=-DbfUser=xxx -DbfPassword=xxx -DbfProductId=xxx -Dcouchdb.url=xxx -DmarketTradedVolumeDb.name=xxx -DmarketDetailsDb.name=xxx
